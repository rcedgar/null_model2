...
# score_F_hist_v2.py uses --minscore --delta instead of --minscore --maxscore to mitigate
...
ED.maxscore = Args.minscore + Args.bins*Args.delta
ED.minevalue = 1e-20
ED.maxevalue = 1000
ED.read_lookup(Args.lookup)
ED.read_hits(Args.hits, qfldnr, tfldnr, scorefldnr)

maxscore = Args.minscore + Args.delta*(Args.bins + 1)
bin_edges = np.linspace(Args.minscore, maxscore, Args.bins + 1)
